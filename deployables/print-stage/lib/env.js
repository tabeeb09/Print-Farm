...
const envSchema = z.object({
  ...
  KEYCLOAK_COLLECTION_CODE_OVERRIDE_ROLES: z.string().default("owner,collection_code_override"),
  ...
  KEYCLOAK_MANAGEABLE_ROLES: z
    .string()
    .default("viewer,editor,media_admin,technician,print_admin,config_admin,openbao_admin,infra_admin,identity_hr_manager,asset_admin,inventory_view,inventory_unit_admin,collection_code_override"),
  ...
  KEYCLOAK_SMTP_HOST: optionalNonEmptyString,
  KEYCLOAK_SMTP_PORT: z.string().default("465"),
  KEYCLOAK_SMTP_FROM: optionalNonEmptyString,
  KEYCLOAK_SMTP_USER: optionalNonEmptyString,
  KEYCLOAK_SMTP_PASSWORD: optionalNonEmptyString,
  KEYCLOAK_SMTP_SSL: z.string().default("true"),
  KEYCLOAK_SMTP_STARTTLS: z.string().default("false"),
  KEYCLOAK_SMTP_AUTH: z.string().default("true"),
  KEYCLOAK_LOGIN_RESET_PASSWORD_ALLOWED: z.string().default("true"),
  RESEND_API_KEY: optionalNonEmptyString,
  RESEND_FROM_EMAIL: optionalNonEmptyString,
  EMAIL_DAILY_LIMIT: z.coerce.number().int().positive().default(95),
  EMAIL_DAILY_ALERT_RECIPIENT_LIMIT: z.coerce.number().int().positive().max(4).default(4),
  EMAIL_DAILY_ALERT_RESERVE: z.string().default("true"),
  EMAIL_QUOTA_S3_PREFIX: z.string().default("private/system/email-quota"),
  PASSWORD_RESET_TOKEN_S3_PREFIX: z.string().default("private/system/password-reset-tokens"),
